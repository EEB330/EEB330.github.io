...
### 4. *Data Wrangling*
+ [Data IO](../slides/08_DataWrangling1.html)

### 5. *Split-apply-combine + Guest lecture: Finding New Genes (tentative)*
...
**Precept 0**: [*Intro to git*](../slides/precepts/00_intro_to_git.html)

**Precept 1** [*Control Flow in R and Python*](../slides/precepts/01_control_flow.html)

**Precept 2** [*Data IO and String Wrangling*](../slides/precepts/02_io_and_strings.html)

# Exams

- **Midterm programming assignment** - assignment repository to come
  - **Due Oct 13th, 2024, 23:59 EDT**
