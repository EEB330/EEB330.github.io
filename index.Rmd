...
+ [Bioinformatics II](https://github.com/EEB330/slides/raw/main/19_pipeline_example.pptx)
  - [Example pipeline used in class](https://drive.google.com/drive/folders/1R095ywTQ5ZoimMJrLfAiGM_WuaRlrbue?usp=drive_link) (requires Princeton Gdrive loggin to view)

- [Intro to Snakemake](https://github.com/EEB330/slides/raw/main/20_snakemake.pptx)
  - [Example Snakemake workflow used in class](https://drive.google.com/drive/folders/12tGj39RMiEfdkI-wv5dbFwYpPHCuazz2?usp=sharing) (requires Princeton Gdrive loggin to view)
