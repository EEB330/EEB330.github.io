...
+ [Version control (git)](../slides/02_BasicGit.html)

### 2. *Control Flow and Functions (tentative)*

### 3. *Data IO and Regular Expressions (tentative)*
...
**Precept 1**: [*Basic R and git*](../slides/precepts/00_intro_to_git.html)
