...
+ Guest lecture (Cara Weisman): Finding New Genes 

### 6. *Recap + midterm solutions + basic plotting*
+ Recap and midterm solutions
+ [Basic plotting](../slides/12_GrammarOfGraphics.html)

### 7. *Advanced plotting*
+ [Plotting aesthetics](../slides/13_GrammarOfGraphics2.html)
+ [Data visualization](../slides/14_MakingPlots.html)

### 8. *Statistics and data science*
+ [Statistics with python I](../slides/15_python_stats.html)
+ [Statistics with python II](../slides/16_python_stats_2.html)
+ [Global Tipping Points: Amazon Rainforest](../slides/EEB330_Nov_6_Amazon.pdf)
+ [Complex Systems & Early Warning Signals](../slides/EEB330_Nov_6_reddit.pdf)

### 9. *Remote servers + bash + Bioinformatics*

+ [Research computing and bash](../slides/17_ResearchComputing.html)
+ [Guest lecture (Andrew Webb): Bioinformatics I](../slides/18_Bioinformatics_1.pdf)

### 10. *Bioinformatics II + Snakemake analysis pipeline*

+ [Guest lecture (Andrew Webb): Bioinformatics II, pipeline example](../slides/19_Bioinformatics_2_pipeline.pdf) + [Slurm scripts](../slides/slurm_pipeline_bioinformatics2.zip)
+ [Guest lecture (Andrew Webb): Bioinformatics III, snakemake](../slides/20_Bioinformatics_3_snakemake.pptx)

### 11. *Spatial data*
+ [Spatial data](../slides/21_spatial_data.html) + [notebook](../slides/21_spatial_data.ipynb)
...
**Precept 6** [*Intro to Plotting*](../slides/precepts/06_plotting.html)

**Precept 7** [*Plotting from Scratch*](../slides/precepts/07_more_plotting.html)

**Precept 8** [*Statistics in Python*](../slides/precepts/08_stats_in_python.html)

**Precept 9** [*Bioinformatics*](../slides/precepts/09_bioinformatics.html)

**Precept 10** [*Snakemake*](../slides/precepts/10_snakemake.html)
...
- **Final programming assignment** - [*final assignment link*](https://classroom.github.com/a/guKlHfFk)
  - **Due Dec 19th, 2023, 23:59 EST**
